...
import { PLAN_DEPTH_LIMITS, TOOLS_PER_CRITERION } from "./budget.js";
import { MAX_CANDIDATES_PER_CRITERION, MAX_EVALUATOR_ARTIFACT_READS, MAX_SOURCES_PER_CLAIM } from "./investigation.js";
export function planningSystemPrompt(project, limits) {
    return [
...
export function planningUserPrompt(project) {
...
export function scoutNudgePrompt() {
    return [
...
export function toolsCapNote(used, cap = TOOLS_PER_CRITERION) {
