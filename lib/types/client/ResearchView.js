        ...
        : verifying
            ...
            : waiting
                ...
                : live
                    ...
                    : '';
    return _jsxs("details", { className: css.scoutCard, "data-status": scout.status, "data-role": scout.role, open: live || waiting || failed || undefined, children: [_jsxs("summary", { className: css.scoutSummary, children: [_jsx("span", { className: css.scoutIcon, "data-status": waiting ? 'waiting' : live ? 'running' : failed || partial ? scout.status : 'done', children: live ? _jsx(IconLoading, { className: css.spinner, size: 14 }) : failed || partial ? _jsx(IconTarget, { size: 14 }) : waiting ? _jsx(IconTarget, { size: 14 }) : _jsx(IconCheck, { size: 14 }) }), _jsxs("span", { className: css.scoutSummaryBody, children: [_jsx("strong", { children: title }), _jsxs("small", { children: [t('investigate.scouts'), ` · ${t('investigate.tools')} ${scout.toolsUsed}/${scout.toolsCap || 10}`, ` · ${t('investigate.evidenceCount', { count: accepted.length })}`, verifying ? ` · ${t('investigate.verifying')}` : '', scout.activeCriterionText === '' || !live ? '' : ` · ${scout.activeCriterionText}`] })] }), _jsx("span", { className: css.scoutStatus, children: scoutStatusLabel(scout, t) }), _jsx(IconChevronDown, { size: 14 })] }), _jsxs("div", { className: css.scoutBody, children: [activity === '' ? null : _jsxs("p", { className: css.scoutActivity, "data-live": live || undefined, children: [live ? _jsx(IconLoading, { className: css.spinner, size: 12 }) : waiting ? _jsx(IconTarget, { size: 12 }) : null, activity] }), question === undefined || question.criteria.length === 0 ? null : _jsx(CriterionList, { criteria: question.criteria, scout: scout, t: t }), (scout.tools ?? []).length === 0 ? null : _jsx("ul", { className: css.toolList, children: scout.tools.map((tool, index) => _jsxs("li", { "data-status": tool.status, children: [_jsx("b", { children: tool.name }), tool.detail] }, `${tool.name}-${index}`)) }), accepted.length === 0 ? null : _jsx("div", { className: css.scoutEvidence, children: accepted.slice(0, 8).map(item => _jsx(EvidenceCard, { evidence: item, t: t }, item.id)) }), scout.dependencySummary === '' ? null : _jsxs("details", { className: css.handoff, open: waiting || undefined, children: [_jsx("summary", { children: t('investigate.dependencySummary') }), _jsx("pre", { children: scout.dependencySummary })] }), scout.scoutDraft.trim() === '' ? null : _jsxs("details", { className: css.handoff, open: live && !verifying || undefined, children: [_jsx("summary", { children: t('investigate.scoutDraft') }), _jsx("pre", { children: scout.scoutDraft })] }), scout.evaluatorDraft.trim() === '' ? null : _jsxs("details", { className: css.handoff, open: verifying || undefined, children: [_jsx("summary", { children: t('investigate.evaluatorDraft') }), _jsx("pre", { children: scout.evaluatorDraft })] }), scout.handoff === '' ? null : _jsxs("details", { className: css.handoff, children: [_jsx("summary", { children: t('investigate.handoff') }), _jsx("pre", { children: scout.handoff })] })] })] });
}
...
function EvidenceCard({ evidence, t }) {
    ...
    return _jsxs("article", { className: css.evidenceCard, "data-status": evidence.status, children: [_jsxs("div", { children: [_jsx("strong", { children: evidence.source }), _jsx("span", { "data-confidence": evidence.confidence, children: evidence.confidence })] }), _jsx("p", { children: evidence.claim }), evidence.snippet === '' ? null : _jsx("blockquote", { children: evidence.snippet }), links.map(url => _jsxs("a", { href: url, target: "_blank", rel: "noreferrer", children: [t('evidence.open'), _jsx(IconExternalLink, { size: 12 })] }, url))] });
}
function ReportPane({ project, t, busy, onRewrite }) {
    ...
    return _jsxs("section", { className: css.reportPane, children: [_jsxs("div", { className: css.sectionHeader, children: [_jsxs("div", { children: [_jsx("h3", { children: t('report.title') }), _jsx("p", { children: t('report.subtitle') })] }), project.planConfirmed && !writing ? _jsx("button", { className: css.primaryButton, type: "button", disabled: busy, onClick: onRewrite, children: project.report ? t('report.retry') : t('investigate.writeReport') }) : null] }), project.report !== null
                ...
                : writing
                    ...
                    : _jsx("div", { className: css.reportPending, children: t('report.empty') }), accepted.length === 0 ? null : _jsxs("section", { className: css.evidencePane, children: [_jsxs("h4", { className: css.boardHeading, children: [t('evidence.title'), " ", _jsx("span", { children: accepted.length })] }), _jsx("div", { className: css.evidenceGrid, children: accepted.map(item => _jsx(EvidenceCard, { evidence: item, t: t }, item.id)) })] }), _jsx(LimitationsBoard, { items: boardLimitations(project, t, false), t: t, always: true })] });
}
