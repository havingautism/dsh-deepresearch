...
export interface ResearchEvidenceRequest { readonly id: ResearchId; readonly questionId: ResearchQuestionId; readonly criterionIds?: string[]; readonly source: string; readonly url?: string; readonly snippet?: string; readonly claim: string; readonly confidence: ResearchConfidence }
...
export interface ResearchCompleteRequest { readonly id: ResearchId; readonly report: string; readonly conclusions?: string[]; readonly limitations?: string[]; readonly partial?: boolean }
